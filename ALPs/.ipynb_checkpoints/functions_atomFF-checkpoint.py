...
#     N_axions=len(axions)
#     func = lambda gayy: R - gayy**2/N_primary*sum(axions[i]['w_angle']*axions[i]['w_prod']*decay_weight(axions[i]['w_LLP_gone']*axions['w_atom_FF'], gayy, l0, Lpipe) for i in range(N_axions))
#     if plot:
